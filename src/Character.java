public class Character {
	...
	private int number; // number of the character (who is the character?)
	...
	private CharSkill[] passiveSkills = null;
	private CharSkill[] activeSkills = null;
	...
	public Character(int number, Player player) {
		this.number = number;
		this.player = player;
		setCharacter();
	}
	...
	private void setValues(boolean male, int job, boolean physical, int attack, int defP, int defM,
			int speed, boolean doracity) {
		this.name = Lang.CharNames[number];
		this.male = male;
		this.job = job;
